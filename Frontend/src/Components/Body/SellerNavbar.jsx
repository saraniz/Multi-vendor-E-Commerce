...
import { FaUserCircle, FaTachometerAlt, FaShoppingCart, FaPlus, FaList, FaCog, FaSignOutAlt } from "react-icons/fa";
      ...
      <div className="flex flex-col items-center p-6 space-y-5 text-white bg-gray-800 shadow-lg w-80">
        ...
        <nav className="w-full">
          ...
          <Link to="/ShopSettings" className="w-full">
            <button className="flex items-center w-full px-4 py-3 text-left transition-all duration-300 ease-in-out bg-gray-700 rounded-lg hover:bg-gray-600 hover:scale-105 hover:shadow-md">
        ...
        {/* Logout Button */}
        <button className="flex items-center w-full px-4 py-3 text-left transition-all duration-300 ease-in-out bg-red-600 rounded-lg hover:bg-red-500 hover:scale-105 hover:shadow-md">
