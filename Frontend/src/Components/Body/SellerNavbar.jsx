  ...
  return (
    <div className="flex justify-center min-h-screen bg-gray-100">
      ...
      <div className="flex flex-col items-center p-4 space-y-4 bg-gray-300 rounded-lg w-96">
        ...
        <Link to='/SellerDashboard' className="w-full"><button className="w-full px-4 py-2 text-center transition-all duration-300 ease-in-out bg-gray-400 rounded-lg hover:bg-gray-500 hover:scale-105 hover:shadow-lg">Dashboard</button></Link>
